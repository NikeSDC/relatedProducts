      ...
      <div className="footerContainer">
        <div className="footerContent">
          <div className="footerInner">
            <div className="footerFirstCollumn">
              <ul>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="https://www.nike.com/gift-cards">GIFT CARDS</a></li>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="https://www.nike.com/promo-code">PROMOTIONS</a></li>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="https://www.nike.com/retail">FIND A STORE</a></li>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="https://www.nike.com/email-signup">SIGN UP FOR EMAIL</a></li>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="https://www.nike.com/register">BECOME A MEMBER</a></li>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="https://www.nike.com/journal/coaching">NIKE JOURNAL</a></li>
                <li className="footerListItem" className="footerCollumnOne"><a className="footerLinkBold" href="#site-feedback">SEND US FEEDBACK</a></li>
              </ul>
            </div>
            <div className="footerHelp">
              <ul>
                <li className="footerListItem"><a className="footerLinkBold" href="https://www.nike.com/help">GET HELP</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/orders/details/">Order Status</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/help/a/shipping-delivery">Shipping and Delivery</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/help/a/returns-policy">Returns</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/help/a/payment-options">Payment Options</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/orders/gift-card-lookup">Gift Card Balance</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/help/#contact">Contact Us</a></li>
              </ul>
            </div>
            <div className="footerAbout">
              <ul>
                <li className="footerListItem"><a className="footerLinkBold" href="http://about.nike.com/">ABOUT NIKE</a></li>
                <li className="footerListItem"><a className="footerLink" href="http://news.nike.com/">News</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://jobs.nike.com/">Careers</a></li>
                <li className="footerListItem"><a className="footerLink" href="http://investors.nike.com/">Investors</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://purpose.nike.com/">Purpose</a></li>
                <li className="footerListItem"><a className="footerLink" href="https://www.nike.com/sustainability">Sustainability</a></li>
              </ul>
            </div>
            <div className="footerRight">
              <div className="footerSocialMedia">
              <a href="https://twitter.com/Nike" className="socialMediaIcon">
              ...
              <a href="https://www.facebook.com/nike" className="socialMediaIcon">
                <svg className="social-link-icon" width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
              ...
              <a href="https://www.youtube.com/user/nike" className="socialMediaIcon">
                <svg className="social-link-icon" width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
              ...
              <a href="https://instagram.com/nike" className="socialMediaIcon">
                <svg className="social-link-icon" width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
          ...
          <div className="footerLocation">
            <a className="footerLocationATag" href="//www.nike.com/language_tunnel">
              <svg className="footerLocationSVG" height="15px" width="18px" fill="#111" viewBox="0 0 42 58">
              ...
              <span className="countryLabel">United States</span>
            </a>
            <div className="footerCopyRight">© 2021 Nike, Inc. All Rights Reserved</div>
          </div>
